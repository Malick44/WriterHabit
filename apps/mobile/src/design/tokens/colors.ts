...
export const colors = {
  ...
  dashboard: {
    background: "#F8F9FF",
    backgroundOverlay: "rgba(248, 249, 255, 0.95)",
    card: "#FFFFFF",
    ...
    outline: "#737784",
    outlineFaint: "rgba(195, 198, 213, 0.45)",
    outlineVariant: "#C3C6D5",
    primary: "#00327D",
    primaryContainer: "#0047AB",
    primaryFixed: "#DAE2FF",
    primaryFixedBorder: "#B1C5FF",
    primaryMuted: "rgba(0, 50, 125, 0.4)",
    ...
    secondarySoft: "rgba(0, 108, 73, 0.2)",
    surface: "#F8F9FF",
