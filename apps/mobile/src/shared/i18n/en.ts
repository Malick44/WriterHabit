export const en = {
  ...
  grade3WritingAdventure: {
    ...
    home: {
      complete: "Done!",
      continueDay: "Keep going: Day {{day}}",
      continueDayAccessibility: "Continue the adventure on day {{day}}",
      dayTitle: "Day {{day}}",
      headerTitle: "My Adventure",
      heroSubtitle: "{{completed}} of {{total}} days done",
      heroTitle: "Your 30-day quest",
      locked: "Not yet",
      openDay: "Start",
      parentGuideLink: "For grown-ups: Parent guide",
      progressAccessibility: "Grade 3 adventure completion progress",
      revisitDay: "Play again",
      startDay: "Start Day {{day}}",
      subtitle: "Read, talk, and write a little every day.",
      todayBadge: "Today",
      trailDayAccessibility: "Day {{day}}: {{title}}. {{status}}",
      completedGroup: "Days {{from}}–{{to}}",
      completedGroupAccessibility:
        "Days {{from}} to {{to}}, all done. Tap to show or hide them.",
      upcomingGroupAccessibility:
        "Days {{from}} to {{to}} are still locked. Tap to peek at what is coming.",
      title: "Grade 3 Writing Adventure",
      unlocked: "Ready!",
    },
    lesson: {
