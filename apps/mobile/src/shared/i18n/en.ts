export const en = {
  ...
  studentHome: {
    ...
    grade3Adventure: {
      ...
      description: "A 30-day read, talk, draw, handwrite, and revise program.",
      eyebrow: "GRADE 3",
      hint: "Open the local Grade 3 writing adventure map.",
      title: "Writing Adventure",
    },
    continue: {
