export const en = {
  ...
  writingWorkspace: {
    ...
    stages: {
      ...
      sketchOnCanvas: "Sketch on Canvas",
      submitSummaryTitle: "Your draft",
      submitChecklistChip: "Checklist {{count}} of {{total}}",
      submitNote: "Submit when the draft includes your own thinking. Feedback closes the loop \u2014 review it to keep your streak growing.",
    },
    metrics: {
      words: "{{count}} words",
  ...
  grade3WritingAdventure: {
    ...
    lesson: {
      ...
      completeNotReady: "Write your draft, make one sentence stronger, and finish the checklist.",
      completeReady: "Everything is ready. Save your win.",
      completeTitle: "Complete day",
      draftLabel: "My writing",
      draftPlaceholder: "Write your ideas here.",
      ...
      strongerPlaceholder: "Try the sentence again with more detail.",
