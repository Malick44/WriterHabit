export const en = {
  ...
  auth: {
    ...
    signIn: {
      ...
      appleUnavailableDescription: "Apple sign-in is visible in the design and will be enabled when the provider is configured.",
    ...
    signUp: {
      appleCta: "Continue with Apple",
      appleUnavailableDescription: "Apple sign-up is visible in the design and will be enabled when the provider is configured.",
  ...
  canvas: {
    ...
    handwriting: {
      ...
      pageIndicator: "Canvas page {{current}} of {{total}}",
      pageIndicatorAccessibility: "Canvas has {{total}} pages",
      autosave: {
      ...
      height: {
        label: "Canvas height",
        accessibility: "Canvas height control",
        title: "Canvas height",
        decrease: "Decrease canvas height",
        increase: "Increase canvas height",
        levels: {
          short: "Short",
          medium: "Medium",
          long: "Long",
        ...
        shrinkWarning: "This page has writing near the bottom. Increase height or move writing before shrinking.",
      },
      position: {
