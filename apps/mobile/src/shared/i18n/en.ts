export const en = {
  ...
  subscriptions: {
    ...
    restore: {
      ...
      hint: "Checks for a previous purchase placeholder in this build.",
      notFoundAccessibility: "No purchases found",
      notFoundDescription: "No active purchase was found for this account in the local placeholder flow.",
