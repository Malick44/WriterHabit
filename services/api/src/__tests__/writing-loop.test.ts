...
describe("WriterHabit writing loop API", () => {
  ...
  async function submitHappyPath(input: { idempotencyKey?: string; studentAssignmentId?: string } = {}) {
    return inject(studentToken, {
      ...
      payload: {
        ...
        typedText: "My paragraph is student-written text. It has two sentences.",
      },
