...
const scenarioEnvKeys = [
  "EXPO_PUBLIC_WriterHabit_ASSIGNMENTS_SCENARIO",
  "EXPO_PUBLIC_WriterHabit_CANVAS_SCENARIO",
  "EXPO_PUBLIC_WriterHabit_ENABLE_CANVAS_BACKEND_SYNC",
  "EXPO_PUBLIC_WriterHabit_FEEDBACK_REVIEW_SCENARIO",
] as const;
